...
import lottery.Lottery; //package name lottery and class is lottery.Lottery
import java.util.*;
...
public class LotteryRunner {
    ...
    public static void main(String[] args) {
        ...
        if(Lottery.Solution1(ticketscollection, test, ticketscollection.length) == false && Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), ticketscollection.length) == true)
        ...
        if(Lottery.Solution2(ticketscollection, 0, ticketscollection.length, test) == false && Lottery.Solution2(ticketscollection, 0, ticketscollection.length, ticketscollection[index].GetTicket()) == true)
